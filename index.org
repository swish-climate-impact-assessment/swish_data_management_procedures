...
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
  ...
  \paragraph*{Abstract:} This unpublished working paper was written to
  accompany the material included in the PhD thesis:
  'Using Reproducible Research Pipelines to Help Disentangle Health Effects of Environmental Changes from Social Factors' by Ivan Hanigan (2016).  It sets out the key data management and analysis principles that were found to be most effective for the reproducibile synthesis and integration of heterogeneous datasets for analysis and reporting.
...
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
  ...
  epidemiologic research programme `r citet(bib[["Peng"]])`.  This can be conceptualised as implementing reproducible
  ...
  effectivly implement 'pipelines' of method steps and tools.  Data
  ...
  problems in a similar way, rather than each analyst configuring a
  pipeline to suit a particular individual or domain-specific
  preferences.
...
#+end_src
** Rmd Data management plan and data inventory
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
    
  ### Data management plan and data inventory
  
  TBA, there is better dev version at /home/ivan_hanigan/projects/swish-dmp/report_swish_data_management_procedures/index.org::DMP and datinv

  
  
#+end_src

** Rmd Case study 2: Visualisation of methods steps using bespoke software
#+name:box1
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
