...
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
  ...
  research pipelines in epidemiology `r citet(bib[["Peng"]])`.  The
  ...
  of population health `r citet(bib[["McMichael2013"]])`.  This document
...
#+end_src
** Rmd Case study 3: Visualisation of methods steps using bespoke software
#+name:box1
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
