#+TITLE: Appendix 1: Evidence-based data analysis pipelines for eco-social epidemiology
#+AUTHOR: Ivan Hanigan
...
#+begin_src R :session *R* :tangle swish-dmp-report.Rmd :exports none :eval no
  ...
  affiliation:
  - affilnum: 1
    affil: Centre for Research and Action in Public Health, University of Canberra, ACT 2617, Australia
  header-includes:
    - \usepackage{graphicx}
    - \usepackage{url}   
  output:
